    ...
    <>
      <nav className="fixed top-0 left-0 z-50 w-full bg-white border-b border-slate-200">
        <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
          ...
          <Link
            href="/contact"
            className="hidden md:inline-block rounded-full bg-blue-600 px-5 py-2 text-sm font-medium text-white hover:bg-blue-700"
          >
            Book Free Class
          </Link>
      ...
      {open && (
        <div className="fixed inset-0 z-40 bg-white flex flex-col items-center justify-center gap-8 text-lg">
          ...
          <Link
            ...
            href="/contact"
            className="rounded-full bg-blue-600 px-8 py-3 text-sm text-white"
          >
            Book Free Class
          </Link>
        </div>
