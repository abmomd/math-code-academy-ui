...
const steps = [
  {
    title: "Step 1: Book a Free Trial Class",
    description:
  ...
  {
    title: "Step 2: Get a Personalized Learning Plan",
    description:
  ...
  {
    title: "Step 3: Start Learning & Track Progress",
    description:
      ...
      <div className="mx-auto max-w-7xl px-6 py-28 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="mt-6 text-lg text-slate-600 max-w-xl">
            Build strong fundamentals, logical thinking, and problem-solving
            skills through expert tutors in live classes —{" "}
        ...
        <div
          ...
          className={`
            ...
            rounded-3xl bg-gradient-to-br ${step.gradient}
            p-10 shadow-[0_25px_70px_-20px_rgba(59,130,246,0.35)]
            transition-all duration-700
            hover:scale-[1.01]
          `}
        >
          <h2 className="text-xl font-bold uppercase tracking-wider text-blue-800 mb-4">
            How It Works
          </h2>
