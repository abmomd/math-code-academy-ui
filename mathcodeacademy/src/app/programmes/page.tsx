        ...
        <section className="relative mx-auto max-w-7xl px-6">
          ...
          <div className="grid gap-12 md:grid-cols-2">
            {programmes[category][subject]?.map((p, i) => (
              <div
                key={i}
                className="relative rounded-3xl bg-white/75 backdrop-blur-xl 
                border border-slate-200 p-8
                shadow-[0_25px_70px_-20px_rgba(0,0,0,0.18)]
              ...
              >
                ...
                <div className="mt-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  ...
                  <a
                    ...
                    className="w-full sm:w-auto rounded-full bg-gradient-to-r from-green-500 to-green-600 
                    px-7 py-3 text-sm font-semibold text-white shadow-lg hover:scale-[1.03] transition"
                  >
                    Book Free Trial
                  </a>
                  ...
                  <a
                    ...
                    className="w-full sm:w-auto rounded-full border border-slate-300 
                    px-7 py-3 text-sm font-semibold text-slate-700 
